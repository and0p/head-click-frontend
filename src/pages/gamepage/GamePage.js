...
class GamePage extends React.Component {
  ...
  render() {
    ...
    if (this.state.valid) {
      ...
      const MiscSettingsHTML = !game.hasOwnProperty("settings") || Object.keys(game.settings).length == 0 ? <div /> :
        /* MISC SETTINGS */
        <Grid item xs={12}>
          <Paper>
            <div className={classes.paper}>
      ...
      return (
        <div className={classes.root}>
          <Typography variant="display1" className={classNames(classes.headline, classes.floatLeft)} gutterBottom>
            {game.name}
          </Typography>
          <div className={classNames(classes.floatRight, classes.favorite)}>
            {profile.ready && <FavoriteButton game={game}/>}
          </div>
          <Grid container spacing={spacing} className={classNames(classes.rootGridContainer, classes.clear)}>
